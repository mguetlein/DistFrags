...
public class OldStringSetDistanceFunction extends NormalizableDistance
{
	public static double MISSING_VALUE = Double.MAX_VALUE;

	SetDistance setDistance;

	public OldStringSetDistanceFunction(SetDistance setDistance)
	{
	...
	protected double difference(int index, Instance first, Instance second)
	{
		...
		switch (m_Data.attribute(index).type())
		{
			case Attribute.STRING:
				...
				diff = setDistance.distance(SetDistanceCache.getMatrix(string1, string2));
